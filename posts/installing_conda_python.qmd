...
At this website, using the tabs on the install instructions, go to the operating system you have on your computer.
...
| **Visual Studio Code<br>**![Visual Studio Code.](post_images/installing-py_logo-VScode.png){ height=50px }        | (+) ±Industry standard, has most advanced features. <br>(+) Plugins for many features. <br>(-) Very counter-intuitive to use. Makes it difficult to use. |
...
The installation of both of these can be done through Conda.

##### Installing Jupyter using Conda

Jupyter can be installed using Conda.

On the official website they say use something called "pip" ([link](https://jupyter.org/install){target=_blank}), but we recommend conda.
