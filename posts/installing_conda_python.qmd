...
Installing Python, its libraries, and code editors, comes with challenges, such as:
...
At this website, choose either "Shell installer" (Windows) or "Terminal installer" (macOS).
<!--go to "Quickstart install instructions", and using the tabs on the install instructions, go to the operating system you have on your computer.
Follow the instructions there.-->
Follow the instructions there. Often, you'll need to copy and paste commands in your terminal/shell (and press enter to execute).
...
![**Miniconda installation instructions from Anaconda.com.**. *In this step, the command needs to be copied and pasted to your terminal.*](post_images/installing-py_screenshow-miniconda-2026.png){ width=50% fig-align="left" }
...
For our workshops, depending on the topic, we either use Jupyter notebooks or Spyder.
