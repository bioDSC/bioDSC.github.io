...
The *bio*DSC core team consists of three members; Frans van der Kloet, Martijn Wehrens, and Misha Paauw. 
...
My main interest is in (pre)processing of large data-sets (with a preference for high resolution mass spectrometry data) and the development and implementation of data analysis and pre-processing tools are often further complicated because of these large data sizes.
