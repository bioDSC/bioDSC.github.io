...
After studying biology and chemistry in Nijmegen (BSc, RU), I obtained a degree in theoretical chemistry at the UvA (MSc). Remaining in Amsterdam, I obtained my PhD at AMOLF, where I worked on tracking single bacteria using time lapse microscopy to understand gene regulation at the single cell. I then moved to the Hubrecht Institute in Utrecht to further work on understanding cells at the fundamental level by using RNA-seq to understand heart disease as a postdoc.

At the bioDSC, I have fun writing scripts and lending my expertise to further understand all the amazing biological processes that occur in cells.
