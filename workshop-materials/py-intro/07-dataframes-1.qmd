...
1. Create some sample data
    1. Create a plain text file on your computer, and give it the extension `.csv`. 
    2. Find out what the comma-separated format looks like. 
    3. Use your imagination to complete the following table and put it in the `.csv` file. 
    ...
    4. Let's do some unethical data massaging, and tweak the csv such that you get a significant p-val between the two conditions
...
A possible data file (saved as [mydata.csv](data/mydata.csv)) could look like:
...
```
4. The code calulates the t-statistic between the two conditions and its associated p-value.
