...
A computer can work more efficiently with integer numbers, so if you now you only need integer numbers,
...
Automatic conversion occurs to convert all elements to the same type (in this case string takes presedence). 
...
my_array.dtype
```
'<U21' referst to a specific kind of string.
